 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ze extends Nt{constructor(t){if(super(t),this.it=h,t.type!==Lt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===h||t==null)return this._t=void 0,this.it=t;if(t===J)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}ze.directiveName="unsafeHTML",ze.resultType=1;const ie=It(ze);function L(e,t){e.dispatchEvent(new CustomEvent("save-status",{detail:{status:t},bubbles:!0,composed:!0}))}function be(e,t){e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}var Wt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,G=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ut(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Wt(t,i,o),o};let U=class extends P{constructor(){super(...arguments),this.schedules=[],this.scheduleSelectorEntity="",this.activeScheduleIndex=0,this.comfortTemp=21,this.ecoTemp=17,this.editing=!1}render(){return this.editing?this._renderEditMode():this._renderViewMode()}_renderViewMode(){var i,s,o,a;const e=this.hass.language,t=this.schedules.length>=2;return l`
  ...
  `,G([_({attribute:!1})],U.prototype,"hass",2),G([_({attribute:!1})],U.prototype,"schedules",2),G([_({type:String})],U.prototype,"scheduleSelectorEntity",2),G([_({type:Number})],U.prototype,"activeScheduleIndex",2),G([_({type:Number})],U.prototype,"comfortTemp",2),G([_({type:Number})],U.prototype,"ecoTemp",2),G([_({type:Boolean})],U.prototype,"editing",2),U=G([N("rs-schedule-settings")],U);var Vt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,I=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ft(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Vt(t,i,o),o};let R=class extends P{constructor(){super(...arguments),this.selectedThermostats=new Set,this.selectedAcs=new Set,this.selectedTempSensor="",this.selectedHumiditySensor="",this.selectedWindowSensors=new Set,this.windowOpenDelay=0,this.windowCloseDelay=0,this.editing=!1,this._entityFilter=e=>{var i,s,o,a;const t=e.entity_id;if(this.selectedThermostats.has(t)||this.selectedAcs.has(t)||this.selectedTempSensor===t||this.selectedHumiditySensor===t||this.selectedWindowSensors.has(t))return!1;if(t.startsWith("sensor.")){const r=(s=(i=this.hass.states[t])==null?void 0:i.attributes)==null?void 0:s.device_class;if(r!=="temperature"&&r!=="humidity")return!1}if(t.startsWith("binary_sensor.")){const r=(a=(o=this.hass.states[t])==null?void 0:o.attributes)==null?void 0:a.device_class;if(r!=="window"&&r!=="door")return!1}return!0}}render(){return this.editing?this._renderEditMode():this._renderViewMode()}_renderViewMode(){const e=this.selectedThermostats.size>0||this.selectedAcs.size>0,t=!!this.selectedTempSensor,i=!!this.selectedHumiditySensor;return l`
    ...
    `}_renderEditMode(){var E,f,b,se,M;const e=Ze(this.area.area_id,(E=this.hass)==null?void 0:E.entities,(f=this.hass)==null?void 0:f.devices),t=e.filter(v=>v.entity_id.startsWith("climate.")),i=(b=this.hass)!=null&&b.states?e.filter(v=>{var z,H;return v.entity_id.startsWith("sensor.")&&((H=(z=this.hass.states[v.entity_id])==null?void 0:z.attributes)==null?void 0:H.device_class)==="temperature"}):[],s=(se=this.hass)!=null&&se.states?e.filter(v=>{var z,H;return v.entity_id.startsWith("sensor.")&&((H=(z=this.hass.states[v.entity_id])==null?void 0:z.attributes)==null?void 0:H.device_class)==="humidity"}):[],o=(M=this.hass)!=null&&M.states?e.filter(v=>{var z,H;return v.entity_id.startsWith("binary_sensor.")&&["window","door"].includes((H=(z=this.hass.states[v.entity_id])==null?void 0:z.attributes)==null?void 0:H.device_class)}):[],a=new Set(t.map(v=>v.entity_id)),c=[...new Set([...this.selectedThermostats,...this.selectedAcs])].filter(v=>!a.has(v)),d=new Set(i.map(v=>v.entity_id)),p=this.selectedTempSensor&&!d.has(this.selectedTempSensor)?this.selectedTempSensor:null,g=new Set(s.map(v=>v.entity_id)),m=this.selectedHumiditySensor&&!g.has(this.selectedHumiditySensor)?this.selectedHumiditySensor:null,y=new Set(o.map(v=>v.entity_id)),S=[...this.selectedWindowSensors].filter(v=>!y.has(v));return l`
      <div class="device-group">
        <div class="section-subtitle">${n("devices.climate_entities",this.hass.language)}</div>
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="model-grid">
            ${ae("time_constant",M&&s&&s.U>0?(1/s.U).toFixed(1)+"h":z,"analytics.time_constant","","analytics.info.time_constant")}
            ${E?ae("heating_rate",b&&s?s.Q_heat.toFixed(1):z,"analytics.heating_rate","","analytics.info.heating_rate"):h}
            ${f?ae("cooling_rate",se&&s?s.Q_cool.toFixed(1):z,"analytics.cooling_rate","","analytics.info.cooling_rate"):h}
            ${s&&s.Q_solar>.1?ae("solar_gain",s.Q_solar.toFixed(1),"analytics.solar_gain","","analytics.info.solar_gain"):h}
            ${ae("accuracy_idle",M&&p!=null?"±"+p.toFixed(2)+"°C":z,"analytics.accuracy_idle","","analytics.info.accuracy_idle")}
            ${E?ae("accuracy_heating",b&&g!=null?"±"+g.toFixed(2)+"°C":z,"analytics.accuracy_heating","","analytics.info.accuracy_heating"):h}
          </div>
